...
custom-connector UI connect directly (no ``mcp-remote`` bridge): the SQLite
persistence layer (:mod:`store`), the SDK provider implementation
(:mod:`provider`), and the parent-app authorize/consent bridge (:mod:`consent`).
